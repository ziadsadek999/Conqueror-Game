			...
			if (c.getName().toLowerCase().equals(cityName.toLowerCase())) {
				...
				if (type.toLowerCase().equals("farm") || type.toLowerCase().equals("market")) {
					for (EconomicBuilding e : c.getEconomicalBuildings()) {
						if (e instanceof Farm && type.toLowerCase().equals("farm") || e instanceof Market && type.toLowerCase().equals("market"))
							return;
					}
				} else {
					{
						for (MilitaryBuilding e : c.getMilitaryBuildings()) {
							if (e instanceof ArcheryRange && type.toLowerCase().equals("archeryrange")
									|| e instanceof Barracks && type.toLowerCase().equals("barracks")
									|| e instanceof Stable && type.toLowerCase().equals("stable"))
								return;
						}
					}
				}
